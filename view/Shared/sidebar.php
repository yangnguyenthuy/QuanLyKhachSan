...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="/checkIO">
    <div class=" img-dash">
        <img style="max-width: 65px;" src="../../style/img/logo.png" alt="logo_ks">
...
<li class="nav-item">
    <a class="nav-link" href="../Employee/employeelist.php">
        <i class="fas fa-fw fa-table"></i>
